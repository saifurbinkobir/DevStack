  ...
  return (
    <div className="py-7.5 md:py-15">
      ...
      <div className="md:col-span-7">
        <h1 className="text-[#0F172A] text-[30px] md:text-[60px] text-center md:text-left font-extrabold"  style={{ fontFamily: '"Inter", sans-serif' }}>Build Your Ideal <span className="bg-linear-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] bg-clip-text text-transparent mb-6">Development Stack</span></h1>
      ...
      <div className="md:col-span-5 justify-center md:justify-end flex">
        <img src="/src/assets/banner-stack.png" alt="Banner Stack" className="md:w-120 md:h-120"/>
      </div>
    </div>
    </div>
  );
